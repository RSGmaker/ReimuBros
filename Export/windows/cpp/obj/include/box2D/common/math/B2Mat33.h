...
class HXCPP_CLASS_ATTRIBUTES  B2Mat33_obj : public hx::Object{
	...
	public:
		...
		virtual ::box2D::common::math::B2Vec2 solve22( ::box2D::common::math::B2Vec2 out,Float bX,Float bY);
		Dynamic solve22_dyn();

		virtual ::box2D::common::math::B2Vec3 solve33( ::box2D::common::math::B2Vec3 out,Float bX,Float bY,Float bZ);
		Dynamic solve33_dyn();
